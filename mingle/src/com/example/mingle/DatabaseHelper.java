...
public class DatabaseHelper extends SQLiteOpenHelper  {
	  ...
	  public boolean insertNewUID(String uid, int num, String comm, float dist){
		  SQLiteDatabase db = this.getWritableDatabase();
		  ContentValues values = new ContentValues();
	  ...
	  public ArrayList<ContentValues> getUserList(){
		  SQLiteDatabase db = this.getReadableDatabase();
		  String[] uid_columns={DatabaseHelper.COLUMN_UID, DatabaseHelper.COLUMN_NUM, DatabaseHelper.COLUMN_COMM, DatabaseHelper.COLUMN_DIST};
		  Cursor cursor = db.query(DatabaseHelper.TABLE_UIDLIST,uid_columns,null,null,null,null,null);
